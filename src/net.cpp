...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Wildfire " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"wildfiretools.com", "18.216.96.176"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"wildfiretools.com", "testnet-seed.wildfiretools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Wildfire is probably already running."), addrBind.ToString().c_str());
        else
